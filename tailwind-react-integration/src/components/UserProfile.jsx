function UserProfile() {
  return (
    <div className="bg-gray-100 sm:p-4 md:p-8 max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out text-center">
      ...
      alt="User" 
         className="sm:w-24 sm:h-24 md:w-39 md:w-36 md:h-36 rounded-full mx-auto transform hover:scale-110 transition-transform duration-300 ease-in-out"

      />
      <h1 className="text-lg text-sm md:text-xl text-blue-800 my-4 hover:text-blue-500 transition-colors duration-300 font-semibold">
        John Doe</h1>
